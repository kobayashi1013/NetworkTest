...
namespace Scenes.InLobbyMulti
{
    [RequireComponent(typeof(NetworkObjectTrackingData))]
    public class InLobbyMultiManager : NetworkBehaviour, ISceneManager
    {
        [Header("Prefabs")]
        ...
        public override void Render()
        {
            if (Runner.IsServer)
            {
                ...
                {
                    NetworkManager.Runner.LoadScene(SceneRef.FromIndex((int)SceneName.InGameMultiScene));
                }
            }
        }
